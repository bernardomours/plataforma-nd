            ...
            <div class="flex flex-col">
                <nav class="flex text-xs text-gray-500 mb-1" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1">
                        ...
                        <li aria-current="page" class="text-gray-700 font-medium">Editar Profissional</li>
                    </ol>
                </nav>
        ...
        <form wire:submit.prevent="save" class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input wire:model="phone" type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div wire:ignore>
                        <select x-data="{
                            init() {
                                ...
                                // Injeta o cargo que já estava salvo no banco!
                                tom.setValue('{{ $role }}');
                            }
                        }" class="w-full">
                    ...
                    <div wire:ignore>
                        <select x-data="{
                            init() {
                                ...
                                // Mágica: Puxa o array de IDs salvo no servidor e cria as tags automaticamente
                                tom.setValue(@js($selectedUnits));
                            }
                    ...
                    <div wire:ignore>
                        <select x-data="{
                            init() {
                                ...
                                // Cria as tags com as terapias que o profissional já possuía
                                tom.setValue(@js($selectedTherapies));
                            }
                        }" multiple class="w-full">
