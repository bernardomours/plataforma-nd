    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-200">
            <div class="p-6 border-b border-gray-100 bg-gray-50/50 rounded-t-xl">
                <h3 class="text-lg font-bold text-gray-900">Informações do Usuário</h3>
                <p class="text-sm text-gray-500">Preencha os dados e defina os acessos do novo colaborador.</p>
            </div>
            ...
            <form wire:submit="save" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Senha (Mínimo 8 caracteres) <span class="text-red-500">*</span></label>
                        <input wire:model="password" type="password" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                ...
                <!-- NOVO BLOCO DE FUNÇÕES / CARGOS (CHECKBOXES) -->
                <div>
