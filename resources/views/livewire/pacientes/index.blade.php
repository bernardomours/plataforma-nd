                            ...
                            @hasanyrole('admin|manager|administrative|profissional')
                                <td class="py-3 px-4 text-center">
                                    @if($paciente->trashed())
                                        ...
                                        @endhasanyrole
                                    @else
                                        <a href="{{ route('pacientes.show', $paciente->id) }}" wire:navigate 
                                        class="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 text-xs font-semibold rounded-md hover:bg-blue-100 border border-blue-200 transition-colors shadow-sm w-full sm:w-auto">
                        ...
                        <form wire:submit.prevent="confirmarSaida">
                            <div class="bg-white px-6 pt-6 pb-4">
                                ...
                                <p class="text-sm text-gray-500 text-center mb-5">
                                    Os {{ count($selected) }} paciente(s) selecionado(s) ficarão inativos no system. O motivo abaixo será aplicado a todos eles.
                                </p>
