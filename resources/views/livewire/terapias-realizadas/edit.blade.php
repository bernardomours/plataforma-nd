            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div wire:ignore x-data="{
                        ...
                        init() {
                            ...
                            if ($wire.patient_id) this.tom.setValue($wire.patient_id, true);
                ...
                <div>
                    ...
                    <div wire:ignore x-data="{
                        ...
                        init() {
                            this.tom = new TomSelect(this.$refs.select, { create: false });
                            if ($wire.therapy_id) this.tom.setValue($wire.therapy_id, true);
                ...
                <div>
                    ...
                    <div wire:key="prof-select-{{ $therapy_id ?? 'empty' }}">
                        <div wire:ignore x-data="{
                            ...
                            init() {
                                this.tom = new TomSelect(this.$refs.select, { create: false });
                                if ($wire.professional_id) this.tom.setValue($wire.professional_id, true);
                ...
                <div>
                    ...
                    <div wire:ignore x-data="{
                        ...
                        init() {
                            this.tom = new TomSelect(this.$refs.select, { create: false });
                            if ($wire.service_type_id) this.tom.setValue($wire.service_type_id, true);
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-xl border border-gray-100">
                <div>
                    ...
                    <div class="inline-flex p-1 bg-gray-200 rounded-lg shadow-inner">
                        <button type="button" wire:click="$set('data_rapida', 'ontem')" class="px-4 py-1.5 text-xs font-bold rounded-md transition-all {{ $data_rapida === 'ontem' ? 'bg-yellow-500 text-white shadow-sm' : 'text-gray-600 hover:text-gray-800' }}">Ontem</button>
                        <button type="button" wire:click="$set('data_rapida', 'hoje')" class="px-4 py-1.5 text-xs font-bold rounded-md transition-all {{ $data_rapida === 'hoje' ? 'bg-green-600 text-white shadow-sm' : 'text-gray-600 hover:text-gray-800' }}">Hoje</button>
                        <button type="button" wire:click="$set('data_rapida', 'outro')" class="px-4 py-1.5 text-xs font-bold rounded-md transition-all {{ $data_rapida === 'outro' ? 'bg-gray-600 text-white shadow-sm' : 'text-gray-600 hover:text-gray-800' }}">Outra Data</button>
                    </div>
                </div>
                    ...
                    <div class="inline-block w-full transform overflow-hidden rounded-xl bg-white text-left align-bottom shadow-2xl transition-all sm:my-8 sm:max-w-lg sm:align-middle">
                        ...
                        <div class="border-b border-gray-200 px-6 py-4">
                            ...
                            <p class="mt-1 text-xs leading-relaxed text-gray-500">
                                ...
                                o valor fica gravado nesta consulta e não afeta o cadastro do paciente.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4 px-6 py-5">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Define também a regra de duração da sessão (Humana 40 min; ABA nos demais convênios 60 min).
                                </p>
                            </div>
